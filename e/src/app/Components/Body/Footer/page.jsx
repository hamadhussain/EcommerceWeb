    ...
    <>
      ...
      >
        ...
        >
          ...
          <br /><div>
          <b className=" font-extralight">Email: hammad31012004@gmail.com</b>
          <br />
          <br />
          <b className=" font-extralight">Phone: +923462351008</b></div>
        </div>
        <div className="powered flex gap-2">Powered By  <svg className=" text-pink-700"
          width="15"
          height="15"
          viewBox="0 0 15 15"
          fill="none"
